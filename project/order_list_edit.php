...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT id, username, date FROM order_summary WHERE id = ? LIMIT 0,1";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}"); ?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                <tr>
                    ...
                    <td><textarea name='username' class='form-control'><?php echo htmlspecialchars($username, ENT_QUOTES);  ?></textarea></td>
                </tr>
                <tr>
                    <td>order_date</td>
                    <td><input type='text' name='date' value="<?php echo htmlspecialchars($date, ENT_QUOTES);  ?>" class='form-control' /></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
